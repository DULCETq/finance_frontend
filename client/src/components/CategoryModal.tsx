...
const CategoryModal: FC<ICategoryModal> = ({type, id, setVisibleModal}) => {
    return (
        <div
            className='fixed top-0 left-0 bottom-0 right-0 w-full h-full bg-black/50 flex justify-center items-center'>
            <Form
                action='/categories'
                method={type}
                ...
                <label htmlFor="title">
                    ...
                    <input className='input w-full' type="text" name='title'
                           placeholder='Title...'/>
